...
public class TripDetailsActivity extends AppCompatActivity {
    ...
    TextView txt_car_model,txt_car_number,txt_car_max_passengers,
            ...
            txt_trip_start_distance,txt_trip_end_distance,txt_reserved_seats,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_trip_start_distance = findViewById(R.id.txt_trip_start_distance);
        txt_trip_end_distance = findViewById(R.id.txt_trip_end_distance);
       ...
       btn_cancel_reservation.setOnClickListener(new View.OnClickListener() {
                     ...
                     firestore.collection("rides")
                             ...
                             .addOnFailureListener(new OnFailureListener() {
                                 ...
                                 public void onFailure(@NonNull Exception e) {
                                     ...
                                     makeText(TripDetailsActivity.this,"Error :"+e.getMessage() , LENGTH_LONG).show();
        ...
        btn_send_review.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SharedPreferences sharedPreferences=TripDetailsActivity.this.getSharedPreferences("aladarbi",MODE_PRIVATE);
                ...
                firestore.collection("rides")
                        ...
                        .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                            ...
                            public void onSuccess(DocumentReference documentReference) {
                                ...
                                makeText(TripDetailsActivity.this,"تم إرسال التقييم بنجاح" , LENGTH_LONG).show();
        ...
        firestore.collection("trips")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        ...
                        txt_trip_start_distance.setText(distance_label(dis));

                        LatLng t_end=new LatLng(trip.getEnd_point().getLatitude(),
                                trip.getEnd_point().getLongitude());

                        dis= SphericalUtil.computeDistanceBetween(finish_point,t_end);

                        txt_trip_end_distance.setText(distance_label(dis));

                        btn_view_on_map.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {

                                Intent intent = new Intent(TripDetailsActivity.this,ViewTripPathActivity. class);
                                                                ...
                                                                if(ride.getStatus().equals("منتهية")) {
                                                                    ...
                                                                    if (reservation.isPaid()) {
                                                                        ...
                                                                        btn_pay.setOnClickListener(new View.OnClickListener() {
                                                                            @Override
                                                                            public void onClick(View view) {
                                                                                Intent intent = new Intent(TripDetailsActivity.this,PayReservationActivity. class);
                                                                                intent.putExtra("ride_id",ride_id);
                                                                                intent.putExtra("reservation_id",reservation.getId());
                                                                                intent.putExtra("driver_id",ride.getDriver_id());
        ...
        firestore.collection("rides")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                            ...
                            firestore.collection("rides")
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void unused) {
                                            ...
                                            makeText(TripDetailsActivity.this, "تم إلغاء الحجز بنجاح", LENGTH_LONG).show();
                                            load_trip();
                                        }
                                    });
                        ...
                        notification.setType("Cancel Reservation");
                        notification.setRide_id(ride_id);
                        List<String> to=new ArrayList<>();
                        to.add(ride.getDriver_id());
                        notification.setTo(to);
                        SimpleDateFormat simpleDateFormat=new SimpleDateFormat("yyyy-MM-dd");
                        String date=simpleDateFormat.format(ride_date);
                        notification.setContent("إلغاء حجز " + user_name+  " بتاريخ "+date);
                        notification.setFrom(firebaseAuth.getUid());
                        notification.setTrip_id(trip_id);
                        ...
                        firestore.collection("rides")
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void unused) {
                                        ...
                                        makeText(TripDetailsActivity.this,"تم إضافة الحجز بنجاح" , LENGTH_LONG).show();
                                        ...
                                        SimpleDateFormat simpleDateFormat=new SimpleDateFormat("yyyy-MM-dd");
                                        String date=simpleDateFormat.format(ride_date);
                                        notification.setContent("حجز جديد باسم " + user_name+  " بتاريخ "+date);
                                        notification.setFrom(firebaseAuth.getUid());
                                        notification.setTrip_id(trip_id);
                                        DocumentReference doc=firestore.collection("notifications")
                                                .document();
